...
(function($) {
	...
	$.fn.nivoSlider.defaults = {
		effect: 'slideInLeft', //Imposta l'effetto di transizione
		slices: 15, //Imposta le caratteristiche visive di alcune transizioni
		animSpeed: 1000, //Velocitˆ della transizione in millisecondi, 500 = mezzo secondo
		pauseTime: 6000, //Durata della visualizzazione dell'immagine in millisecondi, 3000 = 3 secondi
		...
		controlNavThumbs: true, // Imposta la navigazione attraverso miniature delle immagini
        controlNavThumbsFromRel: true,
		controlNavThumbsSearch: '.jpg',
		controlNavThumbsReplace: '_thumb.jpg',
		keyboardNav: true, //Navigazione da tastiera
		pauseOnHover: true, //Impostato su true fa s“ che l'immagine si fermi se il cursore del mouse  su di essa 
		manualAdvance: false,
		captionOpacity: 0.8, //Opacitˆ della didascalia
